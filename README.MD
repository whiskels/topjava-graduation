...
As a result, provide a link to github com.whiskels.graduation.repository. It should contain the code, README.md with API documentation and couple curl commands to test it.
