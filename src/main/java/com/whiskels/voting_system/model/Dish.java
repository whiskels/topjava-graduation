...
@Entity
@Table(name = "dish", uniqueConstraints = {@UniqueConstraint(columnNames = {"restaurant_id", "name", "date"}, name = "dish_unique_restaurant_name_date_idx")})
@Getter
@Setter
@NoArgsConstructor
public class Dish extends AbstractNamedEntity implements HasId {
    ...
    public Dish(Dish d) {
        this(d.getId(), d.getAdded(), d.getName(), d.getPrice(), d.getRestaurant());
    }
