...
public class DishTestData {
    ...
    public static final Dish DISH_1 = new Dish(DISH_1_ID, LocalDate.now(), "Caprese Burger", 500L);
    public static final Dish DISH_2 = new Dish(DISH_2_ID, LocalDate.now(), "Borsch", 300L);
    public static final Dish DISH_3 = new Dish(DISH_3_ID, LocalDate.now(), "New York Cheesecake", 350L);

    public static Dish getNewDish() {
        return new Dish(null, LocalDate.now(), "New", 1000L);
    }
